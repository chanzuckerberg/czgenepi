...
# This template is used as the starting point for all our on-demand and
# scheduled nextstrain runs (scheduled runs are generated by nextstrain-autorun),
# so be aware that modifying variables here affects how all scheduled runs
# function.

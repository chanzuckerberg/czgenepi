...
workflow LoadGenbank {
    ...
    call TransformGenbank {
        ...
        remote_dev_prefix = remote_dev_prefix,
        pathogen_slug = pathogen_slug
        raw_gisaid_object_id = IngestGenbank.entity_id,
    }
    ...
    call AlignGenbank {
        ...
        remote_dev_prefix = remote_dev_prefix,
        pathogen_slug = pathogen_slug
        processed_gisaid_object_id = TransformGenbank.entity_id,
    }
    ...
    call ImportGenbank {
        ...
        remote_dev_prefix = remote_dev_prefix,
        pathogen_slug = pathogen_slug
        gisaid_metadata = AlignGenbank.gisaid_metadata,
    }
    ...
    call ImportLocations {
        ...
        remote_dev_prefix = remote_dev_prefix,
        pathogen_slug = pathogen_slug
        gisaid_import_complete = ImportGenbank.gisaid_import_complete,
    }
    ...
    output {
        Array[File] snakemake_logs = AlignGenbank.snakemake_logs
        File align_log = AlignGenbank.align_log
        String ingest_entity_id = IngestGenbank.entity_id
        String transform_entity_id = TransformGenbank.entity_id
        String align_entity_id = AlignGenbank.entity_id
    }
}
...
task IngestLineages {
    ...
    python3 ./load_lineages.py "${pathogen_slug}" --print-source-file 1>&2
    >>>
...
task AlignGenbank {
    ...
    unxz -k /ncov/results/sanitized_metadata_gisaid.tsv.xz  # make an unzipped version for ImportGenbank. The zipped version goes to S3
    mv /ncov/results/sanitized_metadata_gisaid.tsv metadata.tsv  # this is for wdl to pipe into ImportGenbank.

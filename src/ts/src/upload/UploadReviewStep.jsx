...
class ReviewStep extends React.Component {
    ...
    getFieldDisplayName = (key) => {
        ...
        return projectMetadataFields[key]
            ? projectMetadataFields[key].name
            : key;
    };
                ...
                <div className={cs.flexContent}>
                            ...
                            >
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        logAnalyticsEvent(
                                            "ReviewStep_edit-project-link_clicked",
                                            {
                    ...
                    less hacky way. */}
                                ...
                                <div className={cs.existingSamples}>
                                    {project.number_of_samples || 0} existing
                                    samples in project
                                </div>
                            </div>
                        </div>
                            ...
                            >
                                <div
                                    ...
                                    onClick={() => {
                                        this.onLinkClick("uploadSamples");
                                        logAnalyticsEvent(
                                            "ReviewStep_edit-samples-link_clicked",
                                            {
                                                projectId: project.id,
                                                projectName: project.name,
                                                uploadType: uploadType,
                                ...
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        logAnalyticsEvent(
                                            "ReviewStep_edit-metadata-link_clicked",
                                            {
                                                projectId: project.id,
                                                projectName: project.name,
                                                uploadType: uploadType,
                        ...
                        {admin && (
                            <AdminUploadOptions
                                ...
                                onAdminOptionsChanged={
                                    this.handleAdminOptionsChanged
                                }
                            />
                        )}
                    </div>
                    ...
                    <TermsAgreement
                        ...
                        onChange={() =>
                            this.setState(
                                ...
                                () =>
                                    logAnalyticsEvent(
                                        "ReviewStep_consent-checkbox_checked",
                                        {
                                            consentChecked: consentChecked,
                                        }
                                    )

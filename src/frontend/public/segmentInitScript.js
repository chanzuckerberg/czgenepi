...
(function () {
  // REMOVE, both console.logs below. Here for now to validate OneTrust use.
  console.log("Sgment analytics about to be loaded."); // REMOVE eventually
  ...
  analytics.page();
  console.log("Segment analytics load should be complete."); // REMOVE eventually
  }}();
})();

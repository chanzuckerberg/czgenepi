...
//   const startDate = item.template_args?.filter_start_date
// }
...
const TreeTableNameCell = ({ value, item }: Props): JSX.Element => {
  ...
  const onDetailsOpen = (e) => {
    e.stopPropagation();
    console.log(item);
  };

  // const filterDetails = [
  //   {label: "Location", value: item.template_args}
        ...
        <CellWrapper data-test-id="tree-name-cell">
          ...
          <StyledNameWrapper>
            ...
            <StyledTreeCreator data-test-id="tree-creator-name">
              <Tooltip placement="bottom" title="test" onOpen={onDetailsOpen}>
                <p>Details</p>
              </Tooltip>
              |&nbsp;&nbsp;
              {displayName}

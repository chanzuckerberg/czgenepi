...
export async function uploadSequencingFiles(
  page: Page,
  uploadData: UploadData
): Promise<any> {
  //click upload button
  await page.locator("a[href$='/upload/step1']").click();
  await getSampleDataFile(page, uploadData.dataFile);
  // complete form
...
export async function getSampleDataFile(
  page: Page,
  fileName: string
): Promise<void> {
...
export function getSampleData(): Array<SampleData> {
  return [
    {

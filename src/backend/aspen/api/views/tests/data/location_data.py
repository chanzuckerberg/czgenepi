...
TEST_COUNTRY_DATA = [
    ...
    Point("Africa", "Madagascar", None, None, -18.56, 47.31),
    Point("Africa", "Madagascar", "Analamangra", None, -18.56, 47.31),
    Point("Africa", "Madagascar", "Analamangra", "Antananarivo", -18.56, 47.31),
    Point("Africa", "Kenya", None, None, -1.30316895, 36.8260612241051),
    Point("Africa", "Kenya", "Nairobi", None, -1.30316895, 36.8260612241051),
    Point("Africa", "Kenya", "Nairobi", "Nairobi", -1.30316895, 36.8260612241051),
    Point("Asia", "Singapore", None, None, 1.344189, 103.867546),
    Point("Asia", "Singapore", "Singapore", None, 1.344189, 103.867546),
    Point("Asia", "Singapore", "Singapore", "Singapore", 1.344189, 103.867546),
    Point("Europe", "Italy", None, None, 41.881118, 12.492817),
    Point("Europe", "Italy", "Lazio", None, 41.881118, 12.492817),
    Point("Europe", "Italy", "Lazio", "Rome", 41.881118, 12.492817),
    Point("South America", "Brazil", None, None, -21.032238, -51.210045),
    Point("South America", "Brazil", "São Paulo", None, -21.032238, -51.210045),
    Point("South America", "Brazil", "São Paulo", "São Paulo", -21.032238, -51.210045),
    Point("Africa", "Angola", None, None, -8.8272699, 13.2439512),
    Point("Africa", "Angola", "Luanda", None, -8.8272699, 13.2439512),
    Point("Africa", "Angola", "Luanda", "Luanda", -8.8272699, 13.2439512),
    Point("Europe", "Slovenia", None, None, 45.8133113, 14.4808369),
    Point("Europe", "Slovenia", "Ljubljana", None, 45.8133113, 14.4808369),
    Point("Europe", "Slovenia", "Ljubljana", "Ljubljana", 45.8133113, 14.4808369),
    Point("Europe", "Denmark", None, None, 55.6867243, 12.5700724),
    Point("Europe", "Denmark", "Hovedstaden", None, 55.6867243, 12.5700724),
    Point("Europe", "Denmark", "Hovedstaden", "Copenhagen", 55.6867243, 12.5700724),
    Point("South America", "Curaçao", None, None, 12.11000695, -68.9370850600204),
    Point(
        "South America", "Curaçao", "Willemstad", None, 12.11000695, -68.9370850600204
    ),
    Point(
        "South America",
        "Curaçao",

#!/bin/bash -e
python3 /usr/src/app/aspen/workflows/ingest_gisaid/save.py --test --aspen-workflow-rev test --aspen-creation-rev test --start-time 1234 --end-time 1234 --gisaid-s3-bucket test --gisaid-s3-key test

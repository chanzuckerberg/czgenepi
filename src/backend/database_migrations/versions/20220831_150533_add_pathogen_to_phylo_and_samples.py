...
def downgrade():
    ...
    op.drop_column("samples", "pathogen_id", schema="aspen")
    ...
    op.alter_column(
        ...
        existing_type=sa.VARCHAR(),
        comment=None,
        existing_comment="Public Repository abbreviated name (ex: GISAID/GenBank)",
        existing_nullable=False,
        schema="aspen",
    )
    op.drop_constraint(
    ...
    op.drop_column("phylo_trees", "pathogen_id", schema="aspen")
    op.drop_constraint(
        op.f("fk_phylo_runs_pathogen_id_pathogens"),
        "phylo_runs",
        schema="aspen",
    ...
    op.drop_column("phylo_runs", "pathogen_id", schema="aspen")
    op.alter_column(
        "pathogens",
        "name",
        existing_type=sa.VARCHAR(),
        comment=None,
        existing_comment="full pathogen abbreviated name, ex: SARS-CoV-2",
        existing_nullable=False,
        schema="aspen",
    )
    op.alter_column(
        ...
        existing_type=sa.VARCHAR(),
        comment=None,
        existing_comment="Used as a URL param for differentiating functionality within CZGE, ex: SC2",
        existing_nullable=False,
        schema="aspen",
    )
    op.alter_column(
        ...
        existing_type=sa.VARCHAR(),
        comment=None,
        existing_comment="identifier samples prefix, ex: hCoV-19",
        existing_nullable=False,
        schema="aspen",
    )
